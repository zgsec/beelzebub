...
func adminBaitKeys(u *AdminUser) []map[string]interface{} {
	...
	return []map[string]interface{}{
		...
		// Second key matches oracle user_info.json keys[1]: alias "deep",
		// max_budget 999999, user_id null, created_by = rendered user's id.
		// Canary token/key_name are placeholder strings; live Canarytokens
